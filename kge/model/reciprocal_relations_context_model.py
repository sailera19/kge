...
class ReciprocalRelationsContextModel(KgeContextModel):
    ...
    def score_sp_po(
        ...
        **kwargs,
        ...
        context_s, context_p, attention_mask = self.embed_context(s, p, o)

        context_o, context_p_inv, attention_mask_inv = self.embed_context(o, p + self.dataset.num_relations(), s, s_embedder=o_embedder)
